...
//    myGLCD.fillRect(399, 87, 414, 97); // Blankout ghost score diff=6 Larry comment out
//    myGLCD.fillRect(7, 87, 22, 97);   // Blankout pacman score
//    myGLCD.fillRect(107, 87, 122, 97);   // Blankout pacman score Larry comment out
...
//    myGLCD.drawBitmap (146, 168, 28, 28, fruit); //   draw fruit 
    myGLCD.drawBitmap (230, 248, 28, 28, fruit); //   draw fruit 
    fruitdrawn = true;
}  
...
//    myGLCD.printNumI(d1,10,70); // Printing this number impacts LFH walls so redraw impacted area   
    myGLCD.printNumI(d1,-5,90); // Printing this number impacts LFH walls so redraw impacted area   
...
if((d2 != c2)||(xsetup == true)){
  myGLCD.printNumI(d2,95,90); // Print 0
}

// Third Digit
if((d3 != c3)||(xsetup == true)){
  myGLCD.printNumI(d3,210,90); // Was 203   
}

// Fourth Digit
if((d4 != c4)||(xsetup == true)){
  myGLCD.printNumI(d4,315,90); // Was 284  
}
...
if (alarmstatus == true) { // Print AS on fron screenleft hand side
  ...
  myGLCD.setColor(255, 255, 255);
  myGLCD.setBackColor(0, 0, 0);
  myGLCD.fillCircle(200, 150, 5);
  myGLCD.fillCircle(200, 170, 5);
